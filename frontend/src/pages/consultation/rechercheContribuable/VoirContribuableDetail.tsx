...
<div className="flex flex-row mt-6 justify-between">
  ...
  ></Input>
                ...
                <div className="mt-6 overflow-y-auto px-20 ">
                    <Table headers={HeaderVehicule} data={DataVehicule} className=" overflow-y-auto border item-center bg-black w-[1000px]" ></Table>
                </div>
                ...
                <div className="mt-6 overflow-y-auto px-20">
                    <Table headers={HeaderAssujetissement} data={DataAssujetissement} className="overflow-y-auto border item-center text-center w-[1000px]"></Table>
                </div>
...
<div className="flex flex-row mt-6 justify-between">
  ...
  return (
    <MainLayout>
   <div className="overflow-y-auto h-[700px] mt-20 mb-0 ">
   <Card contentCard={contentCard} className="w-[1300px] h-[7420px] mt-20  "></Card> 
   </div>
   </MainLayout>
  )
}
