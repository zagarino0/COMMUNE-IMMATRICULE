...
import Siege from "../../register/Siege";
import Dirigeant from "../../register/Dirigeant";
...
function VoirContribuableDetail() {
  ...
  const [ searchTerm] = useState ("")
    ...
    const DataVehicule = filteredData.map((item:any) =>[
    ...
    useEffect(() => {
      if (selectedContribuable && selectedContribuable.numero_immatriculation) {
        axios.get(`http://localhost:3500/vehicle/ ? id_contribuable=${selectedContribuable.id_contribuable}`)
          .then((response) => setSelectedContribuable(response.data))
    ...
    const DataAssujetissement =data.map ((item:any) =>
        [
          item.assujestissement.imposition,
          item.annee,
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="Activité" className="mt-4 "></Label>
  <Input type="text" placeholder="Activité " className="w-50 text-[17px] text-center"
  value={parsedDataSelected?.activite?.activite || ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    Activite: { ...parsedDataSelected?.Activite, Activite: e.target.value } 
  })}
  ></Input>
</div>
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.registre_commerce: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.date_registre_commerce: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.numero_statistique: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.date_delivrance_statistique: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.statistique: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.norma: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.debut_exercice: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.cloture_exercice: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { ...parsedDataSelected?.activite, activite: e.target.value } 
  })}
...
<div className="flex flex-row mt-6 justify-between">
 ...
 value={parsedDataSelected? parsedDataSelected.siege?.province: ""}
 onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
  ...parsedDataSelected, 
  siege: { 
    ...parsedDataSelected?.siege, 
...
value={parsedDataSelected? parsedDataSelected.siege?.region: ""}
onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
  ...parsedDataSelected, 
  siege: { 
    ...parsedDataSelected?.siege, 
...
value={parsedDataSelected? parsedDataSelected.siege?.district: ""}
onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
  ...parsedDataSelected, 
  siege: { 
    ...parsedDataSelected?.siege, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.siege?.commune: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    siege: { 
      ...parsedDataSelected?.siege, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.siege?.fokontany: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    siege: { 
      ...parsedDataSelected?.siege, 
...
<div className="flex flex-row mt-6 justify-between p-3">
  ...
  <Input type="text" placeholder=" " className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.coordonnees?.longitude: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    coordonnees: { 
      ...parsedDataSelected?.coordonnees, 
      district: e.target.value 
    } 
  })}
  ></Input>
...
<div className="flex flex-row mt-6 justify-between p-3">
  ...
  <Input type="text" placeholder=" " className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.coordonnees?.latitude: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    coordonnees: { 
      ...parsedDataSelected?.coordonnees, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.activite?.activite: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { 
      ...parsedDataSelected?.activite, 
      district: e.target.value 
    } 
  })}
  ></Input>
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="activités Principales" className="mt-4 "></Label>
  <Input type="text" placeholder="
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="Type" className="mt-4 "></Label>
  <Input type="text" placeholder="type" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.activite?.type: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
      district: e.target.value 
    } 
  })}
  ></Input>
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="Adresse actuel (siège)" className="mt-4 "></Label>
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.siege?.adresse_actuel: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    siege: { 
      ...parsedDataSelected?.siege, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.activite?.nombre_salarie: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    activite: { 
      ...parsedDataSelected?.activite, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  <Label text="Nom" className="mt-4 "></Label>
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.nom_dirigent: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.fonction: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="CIN" className="mt-4 "></Label>
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.cin: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="Passport" className="mt-4 "></Label>
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.passport: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  <Label text="Adresse" className="mt-4 "></Label>
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.adresse: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.autre_activite: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.resident: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  value={parsedDataSelected? parsedDataSelected.dirigeant?.email: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
   dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  <Input type="text" placeholder="" className="w-50 text-[17px] text-center"
  value={parsedDataSelected? parsedDataSelected.dirigeant?.telephone: ""}
  onChange={(e: React.ChangeEvent<HTMLInputElement>) => ({ 
    ...parsedDataSelected, 
    dirigeant: { 
      ...parsedDataSelected?.dirigeant, 
...
<div className="flex flex-row mt-6 justify-between">
  ...
  ></Input>
                ...
                <div className="mt-6 overflow-y-auto px-20 ">
                    <Table headers={HeaderVehicule} data={DataVehicule} className=" overflow-y-auto border item-center bg-black w-[1100px]" ></Table>
                </div>
                ...
                <div className="mt-6 overflow-y-auto px-20">
                    <Table headers={HeaderAssujetissement} data={DataAssujetissement} className="overflow-y-auto border item-center text-center w-[1100px]"></Table>
                </div>
