...
function VoirContribuableDetailBloque() {
  ...
  const [add , setAdd] = useState(false);
    ...
    const selectedData = localStorage.getItem("selectedRechercheConsulationDataBloque");
...
export default VoirContribuableDetailBloque