...
function Impression() {
  ...
  const selectedData = localStorage.getItem("selectedImpressionCessationData");
              ...
              <img src={Images} alt="images"  className="w-[180px] h-[100px] px-10 mt-6"/>
                ...
                <h4 className="  text-center font-bold mb-1  mt-4 flex flex-col">
                  ATTESTATION <br />DE CESSATION D'ACTIVITE
                         ...
                         {/* Ajouter un div avec le texte "Duplicata" */}
                         {/* <div className="absolute inset-0 flex justify-center items-center opacity-10">
                          <p className="text-[140px] font-bold text-gray-600 transform -rotate-45">DUPLICATA</p>
                      </div> */}
