...
<div className="text-[#959824] text-4xl ml-60  font-semibold mt-2"><TitleH1 className="text-[#959824] text-4xl  font-semibold border-b-2 mt-2" text="CONSULTATION DES REFERENCES FISCAL DELIVRES"></TitleH1></div>
