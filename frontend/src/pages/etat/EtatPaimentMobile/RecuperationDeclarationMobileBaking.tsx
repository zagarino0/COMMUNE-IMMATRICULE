...
function RecuperationDeclarationMobileBaking() {
  ...
  <div className="text-[#959824] text-3xl  font-semibold border-b-2 border-[#959824] mt-2"><TitleH1 className="text-[#959824] text-3xl  font-semibold border-b-2 border-[#959824] mt-2" text="RECUPERATION DES DECLARATIONS VIA MOBILE BANKING"></TitleH1></div>
