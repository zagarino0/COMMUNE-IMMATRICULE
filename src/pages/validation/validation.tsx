...
function ValidationPage() {
    useEffect(() => {
      ...
      const links = [
        ...
        { title: "Validation des mise à jour sur les renseignements des contribuables", link: "/gerercompte" },
        ...
        { title: "Téléchargement du fichier export Nifonline", link: "/telechargerleguide" },
